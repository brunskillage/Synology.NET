...
namespace SynologyClient
{
    public class AppSettingsClientConfig : ISynologyClientConfig
    {
        public AppSettingsClientConfig()
        {
            ...
            if (string.IsNullOrWhiteSpace(ApiBaseAddressAndPathNoTrailingSlash) || string.IsNullOrWhiteSpace(User) ||
                string.IsNullOrWhiteSpace(Password))
            {
                var machineconfig = RuntimeEnvironment.GetRuntimeDirectory() + "Config\\machine.config";
