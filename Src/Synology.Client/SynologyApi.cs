...
namespace SynologyClient
{
    public class SynologyApi : ISynologyApi
    {
        ...
        public SynologyResponse SynoFileStationListShare(int? offset = null, int? limit = null, sort_by sort_by = sort_by.ctime,
            sort_direction sort_direction = sort_direction.asc, bool onlywritable = false,
        ...
        public SynologyResponse SynoFileStationSearchStart(string folderPath, bool recursive = true,
            ...
            string[] extentionPatterns = null, filetype fileType = filetype.file, long minSizeBytes = 0,
            long maxSizeBytes = Int64.MaxValue,
        ...
        public SynologyResponse SynoFileStationSearchList(string taskId, int? offset = null, int? limit = 100,
            ...
            sort_direction sortDirection = sort_direction.asc, string[] pattern = null, filetype fileType = filetype.file,
        ...
        public SynologyResponse SynoFileStationVirtualFolderList(FileSystemType fileSystemType = FileSystemType.cifs, int? offset = null, int? limit = null,
            sort_by sort_by = sort_by.ctime, sort_direction sort_direction = sort_direction.asc, VirtualFolderListAddtionalOptions additional = null)
        {
            dynamic requiredParams = new {
        ...
        public SynologyResponse SynoFileStationFavoriteList(int? offset = null, int? limit = null, status_filter statusFilter = status_filter.all,
            FileStationFavoriteAddtionalOptions additional = null)
        {
            dynamic requiredParams = new
            {
